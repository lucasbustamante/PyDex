...
#########################################################################################
        ...
        while DexSearch.running:
            ...
            # Terceira linha
            btnOpDelete = Button.RoundRect(mainSurface,(35+0*80,vertOffset+240,160,70),15,"Deletar",30,1,DexSearch.DeleteLetter)
            btnSignSpa = Button.RoundRect(mainSurface,(45+2*80,vertOffset+240,390,70),15,"",30,1,DexSearch.PasteLetter," ")
            btnOpSearch = Button.RoundRect(mainSurface,(45+7*80,vertOffset+240,160,70),15,"Buscar",30,1,DexSearch.PasteLetter,"")

            btnGoBack = Button.RoundRect(mainSurface,(0,0,120,30),10,"< Voltar",20,1,DexSearch.ReturnToMenu)
...
#########################################################################################
            ...
            while not DexSearch.reload:
                ...
                Draw.RoundRect(mainSurface,(40,40,40),(5,5,790,135),15,2,(255,0,0),"Buscar por: " + str(DexSearch.searchVal))
